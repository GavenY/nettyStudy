...
public class NioClient {
    ...
    public NioClient(int prot) throws IOException, InterruptedException {
        ...
        // 连接服务器
        clientSocketChannel.connect(new InetSocketAddress(prot));
        ...
        //连接是异步的， //当CountDownLatch中还有子线程没完成，主线程等待同名，当调用   connected.countDown();或者线程数为0  ，或者被中断 才能执行下去
